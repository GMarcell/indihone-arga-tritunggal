        ...
        <div className="hidden lg:block">
          <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 list-none">
            ...
            <Menu allowHover open={isMenuOpen} handler={setIsMenuOpen}>
              ...
              >
                <MenuItem placeholder="" className={`hover:bg-slate-500 ${lang == 'id' ? 'bg-[#646EE4]' : ''}`} disabled={lang == 'id'} onClick={() => setLang('id')}>
                  <Typography
                    placeholder=""
                    variant="h6"
                    color="black"
                ...
                <MenuItem placeholder="" className={`hover:bg-slate-500 ${lang == 'en' ? 'bg-[#646EE4]' : ''}`} disabled={lang == 'en'} onClick={() => setLang('en')}>
                  <Typography
                    placeholder=""
                    variant="h6"
                    color="black"
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
          ...
          <div className="flex items-center gap-x-1">
            <button className="btn btn-active btn-primary w-1/2" disabled={lang == 'id'} onClick={() => setLang('id')}>
              <Typography placeholder="" className={`${lang == 'id' ? 'text-[#636363]' : ''}`}>Indonesia</Typography>
            </button>
            <button className="btn btn-active btn-primary w-1/2" disabled={lang == 'en'} onClick={() => setLang('en')}>
            <Typography placeholder="" className={`${lang == 'en' ? 'text-[#636363]' : ''}`}>English</Typography>
            </button>
          </div>
        </div>
      </MobileNav>
